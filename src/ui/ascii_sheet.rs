...
#[rustfmt::skip]
pub fn ascii_sheet(id: SpritesheetId) -> AsciiSheet {
	AsciiSheet {
		space:            Sprite::new(id, Rect::from_xywh(  0, 0, 2, 6)),

		upper_a:          Sprite::new(id, Rect::from_xywh(  3, 0, 4, 6)),
		...
		upper_e:          Sprite::new(id, Rect::from_xywh( 23, 0, 3, 6)),
		upper_f:          Sprite::new(id, Rect::from_xywh( 27, 0, 3, 6)),
		upper_g:          Sprite::new(id, Rect::from_xywh( 31, 0, 4, 6)),
		upper_h:          Sprite::new(id, Rect::from_xywh( 36, 0, 4, 6)),
		upper_i:          Sprite::new(id, Rect::from_xywh( 41, 0, 3, 6)),
		upper_j:          Sprite::new(id, Rect::from_xywh( 45, 0, 3, 6)),
		upper_k:          Sprite::new(id, Rect::from_xywh( 49, 0, 4, 6)),
		upper_l:          Sprite::new(id, Rect::from_xywh( 54, 0, 3, 6)),
		upper_m:          Sprite::new(id, Rect::from_xywh( 58, 0, 5, 6)),
		upper_n:          Sprite::new(id, Rect::from_xywh( 64, 0, 4, 6)),
		...
		upper_t:          Sprite::new(id, Rect::from_xywh( 94, 0, 3, 6)),
		upper_u:          Sprite::new(id, Rect::from_xywh( 98, 0, 4, 6)),
		upper_v:          Sprite::new(id, Rect::from_xywh(103, 0, 5, 6)),
		upper_w:          Sprite::new(id, Rect::from_xywh(109, 0, 5, 6)),
		upper_x:          Sprite::new(id, Rect::from_xywh(115, 0, 5, 6)),
		upper_y:          Sprite::new(id, Rect::from_xywh(121, 0, 4, 6)),
		upper_z:          Sprite::new(id, Rect::from_xywh(126, 0, 4, 6)),

		lower_a:          Sprite::new(id, Rect::from_xywh(131, 0, 4, 6)),
		lower_b:          Sprite::new(id, Rect::from_xywh(136, 0, 3, 6)),
		lower_c:          Sprite::new(id, Rect::from_xywh(140, 0, 3, 6)),
		lower_d:          Sprite::new(id, Rect::from_xywh(144, 0, 4, 6)),
		lower_e:          Sprite::new(id, Rect::from_xywh(149, 0, 3, 6)),
		lower_f:          Sprite::new(id, Rect::from_xywh(153, 0, 2, 6)),
		lower_g:          Sprite::new(id, Rect::from_xywh(156, 0, 3, 6)),
		lower_h:          Sprite::new(id, Rect::from_xywh(160, 0, 3, 6)),
		lower_i:          Sprite::new(id, Rect::from_xywh(164, 0, 1, 6)),
		lower_j:          Sprite::new(id, Rect::from_xywh(166, 0, 3, 6)),
		lower_k:          Sprite::new(id, Rect::from_xywh(170, 0, 3, 6)),
		lower_l:          Sprite::new(id, Rect::from_xywh(174, 0, 1, 6)),
		lower_m:          Sprite::new(id, Rect::from_xywh(176, 0, 5, 6)),
		lower_n:          Sprite::new(id, Rect::from_xywh(182, 0, 3, 6)),
		...
		lower_w:          Sprite::new(id, Rect::from_xywh(218, 0, 5, 6)),
		lower_x:          Sprite::new(id, Rect::from_xywh(224, 0, 3, 6)),
		lower_y:          Sprite::new(id, Rect::from_xywh(228, 0, 3, 6)),
		lower_z:          Sprite::new(id, Rect::from_xywh(232, 0, 4, 6)),

		digit_0:          Sprite::new(id, Rect::from_xywh(237, 0, 4, 6)),
		digit_1:          Sprite::new(id, Rect::from_xywh(242, 0, 3, 6)),
		digit_2:          Sprite::new(id, Rect::from_xywh(246, 0, 4, 6)),
		...
		exclamation_mark: Sprite::new(id, Rect::from_xywh(286, 0, 1, 6)),
		question_mark:    Sprite::new(id, Rect::from_xywh(288, 0, 3, 6)),
		colon:            Sprite::new(id, Rect::from_xywh(292, 0, 1, 6)),
		semicolon:        Sprite::new(id, Rect::from_xywh(294, 0, 2, 6)),
		comma:            Sprite::new(id, Rect::from_xywh(297, 0, 2, 6)),
		period:           Sprite::new(id, Rect::from_xywh(300, 0, 1, 6)),
		star:             Sprite::new(id, Rect::from_xywh(302, 0, 3, 6)),
		hashtag:          Sprite::new(id, Rect::from_xywh(306, 0, 5, 6)),
		single_quote:     Sprite::new(id, Rect::from_xywh(312, 0, 1, 6)),
		double_quote:     Sprite::new(id, Rect::from_xywh(314, 0, 3, 6)),
		bracket_l:        Sprite::new(id, Rect::from_xywh(318, 0, 2, 6)),
		...
		brace_l:          Sprite::new(id, Rect::from_xywh(330, 0, 3, 6)),
		...
		underscore:       Sprite::new(id, Rect::from_xywh(362, 0, 4, 6)),
	}
}
